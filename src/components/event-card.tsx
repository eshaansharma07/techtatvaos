      ...
      <div className="event-card-body relative z-10 p-5 md:p-6">
        <div className="flex justify-between gap-5">
          <div className="min-w-0">
            ...
            <p className="mt-3 flex items-center gap-1.5 text-sm text-white/48 md:text-xs">
          ...
          <span
            className={
              event.registrationOpen
                ? "rounded-xl border border-black bg-blue-500 px-3 py-1 font-bold text-white shadow-[2px_2px_0px_0px_rgba(255,255,255,0.2)]"
                : "rounded-xl border border-white/20 bg-white/5 px-3 py-1.5 text-white/48"
            }
          >
            {event.registrationOpen ? "OPEN" : event.status.toUpperCase()}
          </span>
        </div>
      </div>
    </Link>
