...
export function TechnomaniaBackground() {
  return (
    <div className="fixed inset-0 z-[-1] overflow-hidden pointer-events-none select-none">
      {/* Dynamic Ambient Gradient Orbs — Exact TM 3.0 Ice-Blue & Electric Cyan */}
      ...
      <div className="absolute bottom-[10%] left-[20%] w-[550px] h-[550px] rounded-full bg-sky-400/10 blur-[140px]" />
