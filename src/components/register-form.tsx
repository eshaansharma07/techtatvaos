                    ...
                    <div className="glass-brutalist rounded-2xl p-4 md:p-6 border border-white/5 bg-black/20 space-y-4 max-h-[290px] overflow-y-auto scrollbar-thin">
                      ...
                      <div className="space-y-1.5">
                        ...
                        <div className="bg-black/35 rounded-xl p-3 text-xs space-y-1">
                          ...
                          <p className="text-white/40">{leader.email} · {leader.phone} · {leader.uid}</p>
                        ...
                        <div className="space-y-3 pt-3 border-t border-white/5">
                          ...
                          {members.slice(0, activeMemberCount).map((member, i) => (
                            <div key={i} className="bg-black/35 rounded-xl p-3 text-xs space-y-1">
                              ...
                              <p className="text-white/40">{member.email || "N/A"} · {member.phone || "N/A"} · {member.uid || "N/A"}</p>
                  ...
                  >
                    ...
                    {whatsappLink && (
                      <a
                        ...
                        className="w-full max-w-[380px] flex items-center justify-center gap-2.5 rounded-2xl border-2 border-emerald-500/40 bg-emerald-500/10 px-6 py-4 text-sm font-extrabold text-emerald-300 uppercase tracking-wider hover:bg-emerald-500/20 hover:border-emerald-400/60 hover:scale-[1.02] transition-all duration-200 shadow-[0_0_30px_rgba(16,185,129,0.15)]"
                      >
