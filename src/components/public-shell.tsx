...
export async function PublicShell({ children }: { children: React.ReactNode }) {
  ...
  return <main className="site-canvas min-h-screen overflow-hidden bg-ink">
    ...
    <header className="public-header fixed inset-x-0 top-0 z-50 pt-[env(safe-area-inset-top)]">
      <div className="public-header-inner mx-4 mt-2 md:mx-auto flex max-w-7xl xl:max-w-[1380px] 2xl:max-w-[1536px] flex-row items-center justify-between px-5 py-3.5 md:mt-4 md:h-[4.75rem] md:px-5 md:py-0">
        ...
        <Link href="/contact" className="brutalist-btn-theme hidden h-7 items-center gap-1 rounded-lg px-2.5 text-[9px] font-extrabold tracking-widest md:inline-flex shadow-[1px_1px_0px_0px_rgba(255,255,255,0.2)]">
