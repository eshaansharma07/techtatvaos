        ...
        <div className="mt-8 flex flex-col md:flex-row gap-4 items-center justify-between bg-white/[0.02] border border-white/10 rounded-[2rem] p-4 md:p-6 backdrop-blur">
          ...
          <div className="relative w-full md:max-w-md">
            ...
            <input
              ...
              className="w-full bg-black/40 border border-white/5 focus:border-[#00FF66]/30 text-white rounded-xl pl-11 pr-4 py-3 text-sm outline-none transition"
            />
          </div>
              ...
              <button
                ...
                className={`px-4 py-2 rounded-xl text-xs font-bold tracking-wider uppercase transition shrink-0 border ${
                  selectedCategory === cat
                    ? "bg-[#00FF66] border-black text-black shadow-[2px_2px_0px_0px_rgba(255,255,255,0.8)]"
      ...
      {filteredAlbums.length ? (
            ...
            return (
              <Reveal key={album.id} delay={index * 0.05}>
                <Link
                  ...
                  className="glass-brutalist group relative block overflow-hidden rounded-[2.2rem] transition-all duration-500 hover:border-[#00FF66]/40 hover:-translate-y-1.5 min-h-[360px] flex flex-col justify-end"
                >
                  ...
                  <div className="absolute inset-0 z-0 bg-black overflow-hidden">
                    {coverAsset?.url ? (
                      ...
                      <div className="h-full w-full bg-gradient-to-br from-emerald-950/20 to-black flex items-center justify-center">
                  ...
                  <div className="absolute inset-0 bg-[radial-gradient(circle_at_50%_120%,rgba(0,255,102,0.12),transparent_60%)] opacity-0 group-hover:opacity-100 transition-opacity duration-700 pointer-events-none" />
                  ...
                  <div className="absolute top-4 left-4 z-20 flex gap-2">
                    <span className="flex items-center gap-1 rounded-lg border border-white/10 bg-black/60 px-2.5 py-1 text-[8px] font-bold tracking-wider text-white/80 backdrop-blur uppercase">
                      {hasVideo ? <Video size={10} className="text-[#00FF66]" /> : <ImageIcon size={10} className="text-[#00FF66]" />}
                  ...
                  <div className="relative z-10 p-6 md:p-8 flex flex-col justify-end w-full">
                    <div className="flex items-center gap-2">
                      <span className="rounded-lg bg-[#00FF66]/10 border border-[#00FF66]/20 px-2 py-0.5 text-[8px] font-bold tracking-widest text-[#00FF66] uppercase">
                        {album.event || "CLUB LIFE"}
                      </span>
                    </div>

                    <h2 className="mt-3 text-2xl font-bold leading-tight tracking-tight text-white group-hover:text-[#00FF66] transition-colors duration-300">
                      {album.title}
                    </h2>
                    ...
                    <div className="mt-4 overflow-hidden h-0 group-hover:h-8 transition-all duration-300 ease-in-out">
                      <span className="inline-flex items-center gap-1.5 text-[9px] font-bold tracking-wider text-[#00FF66] uppercase">
        ...
        <Reveal>
          <div className="glass-brutalist mt-10 rounded-[2.5rem] p-12 text-center relative overflow-hidden">
            <div className="absolute inset-0 bg-[radial-gradient(circle_at_50%_50%,rgba(0,255,102,0.02),transparent_50%)] pointer-events-none" />
            ...
            <button
              ...
              className="brutalist-btn-green mt-6 rounded-xl px-5 py-2.5 text-xs font-bold"
            >
              Clear filters
            </button>
          </div>
