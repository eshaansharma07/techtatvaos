...
export const portalHost = (process.env.PORTAL_HOST || "techtatvaos-portal.vercel.app").toLowerCase();
const portalHosts = (process.env.PORTAL_HOSTS || `${portalHost},portal.techtatva.in`)
  .split(",")
